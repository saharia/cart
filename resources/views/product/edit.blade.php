...
<div class="" style="margin-top:12px">
  <div class="row">
    ...
    <x-adminlte-card theme="lime" theme-mode="outline">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            {{ old('description') ? old('name') : $product->name }}
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            {{ old('content') ? old('content') : $product->content }}
            </x-adminlte-text-editor>
    ...
    <div class="row">
          ...
          class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}"  value="{{ old('price') ? old('price') : $product->price }}"/>
             @if($errors->has('price'))
                <div class="invalid-feedback">
          ...
          class="form-control {{ $errors->has('scale_price') ? 'is-invalid' : '' }}"  value="{{ old('scale_price') ? old('scale_price') : $product->scale_price }}"/>
          ...
          <div class="row">
            ...
            <div class="form-check">
              <input type="checkbox" class="form-check-input" id="with_storehouse" name="with_storehouse" {{ (old('with_storehouse') || $product->with_storehouse) ? ' checked' : '' }}>
          ...
          <div class="col-md-12">
            ...
            class="form-control {{ $errors->has('quantity') ? 'is-invalid' : '' }}"  value="{{ old('quantity') ? old('quantity') : $product->quantity }}"/>
          ...
          <div class="row">
            <div class="col-md-12">
            <div class="form-check">
              <input type="checkbox" class="form-check-input" id="allow_checkout_when_out_of_stock" name="allow_checkout_when_out_of_stock" {{ (old('allow_checkout_when_out_of_stock') || $product->allow_checkout_when_out_of_stock) ? ' checked' : '' }}>
          ...
          <div class="row">
            ...
            class="form-control {{ $errors->has('weight') ? 'is-invalid' : '' }}" value="{{ old('weight') ? old('weight') : $product->weight }}" />
            ...
            class="form-control {{ $errors->has('length') ? 'is-invalid' : '' }}" value="{{ old('length') ? old('length') : $product->length }}" />
          ...
          <div class="row">
            ...
            class="form-control {{ $errors->has('wide') ? 'is-invalid' : '' }}" value="{{ old('wide') ? old('wide') : $product->wide }}" />
             @if($errors->has('wide'))
                <div class="invalid-feedback">
            ...
            class="form-control {{ $errors->has('height') ? 'is-invalid' : '' }}" value="{{ old('height') ? old('height') : $product->height }}" />
